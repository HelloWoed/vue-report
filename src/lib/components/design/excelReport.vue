                ...
                <table class="table table-header">
                    <tr>
                        <th class="cell" 
                            ...
                            {{index == 0 ? '' : tableHeaderData[index-1].value}}
                        </th>
                    </tr>
                </table>
                <excel-resizer
            ...
            <div class="v-body" ref="body" @contextmenu.prevent="visibleRightMouseMenu($event)">
                <table class="table table-body">
                    <tr v-for="(trItem,rindex) in tableData" :key="rindex" v-show="rindex > 0">
                        ...
                        @mousedown.stop="cindex == 0 ? ()=>{} : cellmousedown(rindex,cindex,tdItem,$event)"
...
export default {
    ...
    methods:{
        ...
        tableEventHandler(item){
            this.toolbarEvent[item.eName].bind(this)(this.tableData);
        },
        deleteRow(){
            deleteRow.bind(this)();
        },
        ...
        setAttribute(data){
            if(data.target == 'cell'){
                ...
                this.$set(this,'tableData',JSON.parse(JSON.stringify(tableData)));
