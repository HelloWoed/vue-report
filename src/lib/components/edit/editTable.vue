<template>
    <div class="excelReport">
        ...
        <div class="v-excel">
            <!-- <div class="tool-bar">
                <ExcelToolBar @setAttribute="setAttribute" @tableEventHandler="tableEventHandler" @initTableRowCol="initTableRowCol" />
            </div> -->
            <!-- <div class="cell-info">
            ...
            <div class="v-body" ref="body" @contextmenu.prevent="visibleRightMouseMenu($event)">
                ...
                <div class="designStep">
                    <excel-border ref="eborder" :paintDash="paintDash" @copyCell="copyCell" :cornerEvent="false" />
        ...
        <div class="foot">
            <el-button size="small" type="primary" @click="saveEditTable">保 存</el-button>
...
import RightMouseMenu from '../design/rightMenu'
import ExcelResizer from '../design/excelResizer'
import ExcelCellEditr from '../design/excelCellEditr'
import ExcelToolBar from '../design/excelToolBar'
import AttrSet from '../design/attrSet'
...
export default {
    ...
    created(){
        ...
        this.tableData = this.attrDataConf.tableData;
    ...
    methods:{
        ...
        reset(){
            ...
            this.$emit('reset',this.tableData);
        },
        setPaintDash(data){
